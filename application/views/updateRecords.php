                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="<?php echo base_url('index.php/Usercontroller/'); ?>" method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="name" name="name" value="<?php echo $userData->name; ?>" placeholder="Enter a username..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                          <input type="text" class="form-control" id="email" name="email" value="<?php echo $userData->email; ?>" placeholder="Enter your email..">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                      	<input type="text" class="form-control" id="phone" name="phone" value="<?php echo $userData->phone; ?>" placeholder="212-999-0000">
                                            </div>
                                        </div>
                                       ...
                                       <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                            	<input type="submit" name="update" value="updateRecords" class="btn btn-success">
