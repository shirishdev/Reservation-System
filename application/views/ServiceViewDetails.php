													...
													foreach($timeSlotsArr as $timeArr){
														...
														<tr>
															...
															foreach($timeArr as $value){
																...
																<td class="timeslots <?php echo $class;?>" data-time="<?php echo $value['time'];?>" data-startts="<?php echo strtotime($value['time']);?>" id="time<?php echo strtotime($value['time']);?>">
	...
	<script type="text/javascript"> 
		$(document).ready(function() {
         ...
         $.ajax({
         	...
         	data: { "service_id":serviceId,"timeslot":timeslots,"date":date},
         	dataType: "html",
